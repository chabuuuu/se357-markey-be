...
class ProductContainer extends BaseContainer {
  constructor() {
    super(Product);
this.container.bind<IProductService<IProduct>>('ProductService').to(ProductService);
this.container.bind<IProductRepository<IProduct>>('ProductRepository').to(ProductRepository);
